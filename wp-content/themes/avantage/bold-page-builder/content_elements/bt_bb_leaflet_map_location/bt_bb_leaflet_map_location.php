...
class bt_bb_leaflet_map_location extends BT_BB_Element {
	...
	function handle_shortcode( $atts, $content ) {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Leaflet Maps Location', 'avantage' ), 'description' => esc_html__( 'OpenSteet Map Location', 'avantage' ), 'container' => 'vertical', 'as_child' => array( 'only' => 'bt_bb_leaflet_map' ), 'accept' => array( 'bt_bb_headline' => true, 'bt_bb_text' => true, 'bt_bb_button' => true, 'bt_bb_icon' => true, 'bt_bb_service_icon' => true, 'bt_bb_image' => true, 'bt_bb_separator' => true, 'bt_bb_service' => true, 'bt_bb_working_hours' => true ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'latitude', 'type' => 'textfield', 'heading' => esc_html__( 'Latitude', 'avantage' ), 'preview' => true ),
				array( 'param_name' => 'longitude', 'type' => 'textfield', 'heading' => esc_html__( 'Longitude', 'avantage' ), 'preview' => true ),
				array( 'param_name' => 'icon', 'type' => 'attach_image', 'heading' => esc_html__( 'Icon', 'avantage' ), 'preview' => true )
			)
		) );
	}
}
